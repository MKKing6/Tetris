...
function updateCurrentPiece() {
  ctx.drawImage(tiles, (imagePx + 1)*(currentPiece[2]-1), 0, imagePx, imagePx, leftGrid+currentPiece[0]*boxLength, topGrid+(19-currentPiece[1])*boxLength, boxLength, boxLength);
}
